...
export default function RedefinirSenha() {
  ...
  async function salvarSenha() {
    ...
    if (error) setErro('Erro ao redefinir: ' + error.message)
    ...
    <div style={{ minHeight:'100vh', background:'linear-gradient(135deg,#1a237e 0%,#283593 50%,#1565c0 100%)', display:'flex', alignItems:'center', justifyContent:'center', padding:16 }}>
      <div style={{ width:'100%', maxWidth:400 }}>
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h1 style={{ color:'#fff', fontSize:'1.6rem', fontWeight:'bold', margin:0 }}>Nova Senha</h1>
        ...
        <div style={{ background:'#fff', borderRadius:16, padding:32, boxShadow:'0 8px 32px rgba(0,0,0,0.2)' }}>
          ...
          {sucesso ? (
            <div style={{ textAlign:'center' }}>
              ...
              <h2 style={{ color:'#1e293b', fontWeight:700, margin:'0 0 8px' }}>Senha redefinida!</h2>
              <p style={{ color:'#64748b', fontSize:14, margin:'0 0 24px' }}>Sua senha foi atualizada com sucesso.</p>
            ...
            <>
              ...
              <div style={{ marginBottom:16 }}>
                <label style={{ display:'block', fontSize:11, fontWeight:600, color:'#94a3b8', textTransform:'uppercase', letterSpacing:1, marginBottom:4 }}>Nova Senha</label>
              ...
              <div style={{ marginBottom:16 }}>
                <label style={{ display:'block', fontSize:11, fontWeight:600, color:'#94a3b8', textTransform:'uppercase', letterSpacing:1, marginBottom:4 }}>Confirmar Senha</label>
