...
export default function Dashboard() {
  ...
  const [usuario, setUsuario] = useState({ email: '', perfil: 'Membro', nome: '', apelido: '', cargoAtual: '' })
  ...
  async function buscarTudo() {
    ...
    try {
      ...
      if (raw) {
        ...
        if (Date.now() - ts < CACHE_TTL && dados.usuario?.cargoAtual !== undefined) {
    ...
    const [
      ...
      supabase.from('mensagens_templates').select('chave, conteudo').in('chave', ['aniversario_irmao_whatsapp', 'aniversario_dependente_whatsapp']),
