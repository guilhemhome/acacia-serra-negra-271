...
function RotaProtegida({ children, modulo, apenasAdm }) {
  ...
  // Pendente: renderiza o EditarPerfil diretamente (sem trocar de URL) para evitar
  // race condition de navegacao encadeada quando vem de /membro ou /dashboard.
